...
function renderCtryCases(){
    var usTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal;
    var itTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var chTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var caTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var cnTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var deTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var frTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var gbTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var nlTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 
    var beTotals = "Confirmed " + confCntryTotal + " Recovered " + recovCntryTotal + " Deaths " + deathCntryTotal; 

    marker1.bindPopup(usTotals).openPopup();
    marker2.bindPopup(itTotals).openPopup();
    marker3.bindPopup(nlTotals).openPopup();
    marker4.bindPopup(cnTotals).openPopup();
    marker5.bindPopup(deTotals).openPopup();
    marker6.bindPopup(frTotals).openPopup();
    marker7.bindPopup(caTotals).openPopup();
    marker8.bindPopup(gbTotals).openPopup();
    marker9.bindPopup(chTotals).openPopup();
    marker10.bindPopup(beTotals).openPopup();
